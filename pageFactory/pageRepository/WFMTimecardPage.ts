...
export class WFMTimecardPage extends WebActions {
    ...
    constructor(page: Page, context: BrowserContext) {
        ...
        // this.APPROVE_OVERTIME = page.locator('//day-details-overtime//button');
        // this.APPROVE_OVERTIME = page.getByLabel('Approve Overtime');
        // this.APPROVE_OVERTIME = page.locator('(//div[@id="approveOvertimeAction.popup"]//button[@aria-label="Approve Overtime"])[2]');
