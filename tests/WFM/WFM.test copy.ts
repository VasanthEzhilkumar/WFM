    ...
    dataSet.forEach((data, index) => {
        ...
        test(testTitle, async ({ loginPage, wfmhomepage, wfmtimecardpage, webActions }) => {
            ...
            await test.step('Select Timeoff for the Emp', async () => {
                ...
                //await wfmhomepage.enterTimeOffByaddPayCode(String(data.Paycode), String(data.Duration), String(data.RangeStartDate));
                await wfmhomepage.enterTimeOffByaddPayCode(String(data.Paycode), "Full Schedule Day", String(data.RangeStartDate));
            });
